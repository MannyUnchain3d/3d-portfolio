import {fortytwo, tahitiwifi, troupesdemarine, clbs, vini} from "../assets/images";
import {
    c,
    cplusplus,
    copyright,
...
export const projects = [
    {
        ...
        theme: "btn-back-blue",
        name: "BrainWash",
        description: "A modern and stylish UX/UI responsive landing page for a fictional AI chatbot. The page features sleek parallax effects and bento box layouts.",
        link: "",
    },
    {
        iconUrl: snapgram,
        theme: "btn-back-pink",
        name: "Meme-a-gram",
        description: "An Instagram clone allowing users to share photos and connect with friends in a familiar social media environment. And infinite scrolling... because why not... 😎",
        link: "",
    },
    {
        iconUrl: snapgram,
